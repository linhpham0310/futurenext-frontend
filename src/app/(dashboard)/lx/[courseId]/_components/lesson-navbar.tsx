...
// TASK: LX-FE-1.1: Thanh điều hướng trên cùng không gian học tập
export const LessonNavbar = ({ courseTitle, isAiOpen, onToggleAi }: LessonNavbarProps) => {
  return (
    <div className="h-16 border-b bg-white flex items-center justify-between px-6 shadow-sm z-50">
      ...
      {/* Nút Bật/Tắt Trợ giảng AI */}
      <button
        onClick={onToggleAi}
        className={`flex items-center gap-x-2 px-3 py-1.5 rounded-lg border text-sm font-medium transition shadow-sm ${
          isAiOpen
